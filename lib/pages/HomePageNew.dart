...
class HomePageNew1 extends StatefulWidget {
  ...
  @override
  HomePageNew1State createState() => new HomePageNew1State();
}
...
class HomePageNew1State extends State<HomePageNew1> {
  HomePageNew1State();
          ...
          child: new GestureDetector(
              onTap: () {
                if (i == 0) {
                 ...
                 currentpayer == "0"
                      ? _OpenBox()
                      : _SecurityBox(new NewConsultationPage());
                }  else if (i == 2) {
                 currentpayer == "0"
                      ? _OpenBox()
                   ...
                   currentpayer == "0"
                      ? _OpenBox()
                      :_SecurityBox(new NewPatientPage());
                } 
                else if (i == 4) {
                  Navigator.push(
                    context,
