...
class CentreFragment extends StatefulWidget {
  CentreFragment();

  @override
  CentreFragmentState createState() => new CentreFragmentState();
}

class CentreFragmentState extends State<CentreFragment> {
  CentreFragmentState();
