...
class HopitauxFragment extends StatefulWidget {
  HopitauxFragment();

  @override
  HopitauxFragmentState createState() => new HopitauxFragmentState();
}

class HopitauxFragmentState extends State<HopitauxFragment> {
  HopitauxFragmentState();
