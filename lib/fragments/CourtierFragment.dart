...
class CourtierFragment extends StatefulWidget {
  CourtierFragment();

  @override
  CourtierFragmentState createState() => new CourtierFragmentState();
}

class CourtierFragmentState extends State<CourtierFragment> {
  CourtierFragmentState();
