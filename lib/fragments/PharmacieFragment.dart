...
class PharmacieFragment extends StatefulWidget {
  PharmacieFragment();

  @override
  PharmacieFragmentState createState() => new PharmacieFragmentState();
}

class PharmacieFragmentState extends State<PharmacieFragment> {
  PharmacieFragmentState();
