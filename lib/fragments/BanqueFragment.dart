...
class BanqueFragment extends StatefulWidget {
  BanqueFragment();

  @override
  BanqueFragmentState createState() => new BanqueFragmentState();
}

class BanqueFragmentState extends State<BanqueFragment> {
  BanqueFragmentState();
